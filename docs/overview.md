...
- Боковое меню (`components/sider/sider.tsx`, `sider.module.css`): на десктопе
  кнопка сворачивания — внизу панели (chevron ←/→); на планшете в открытом виде —
  ярлычок справа от панели, в свёрнутом — слева по центру экрана; клик по
  затемнению вне панели закрывает меню.
