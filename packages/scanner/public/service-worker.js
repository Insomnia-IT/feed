...
!(function () {
    ...
    !(function () {
        ...
        var g,
            ...
            w = function (e) {
                return e || m(x.precache);
            },
            k = function (e) {
                return e || m(x.runtime);
            };
        function _() {
            _ = function () {
                return e;
                ...
                (E.prototype = {
                    ...
                    abrupt: function (e, t) {
                        ...
                        return (
                            (s.type = e),
                            (s.arg = t),
                            i ? ((this.method = 'next'), (this.next = i.finallyLoc), f) : this.complete(s)
                        );
                    },
                        ...
                        function (e) {
                            for (;;)
                                switch ((e.prev = e.next)) {
                                    ...
                                    case 3:
                                        return (
                                            (s = Object.assign(Object.assign({}, a), { ignoreSearch: !0 })),
                                            (e.next = 6),
                                            t.keys(r, s)
                                        );
                                    case 6:
        ...
        var B = (function () {
                function e() {
                    ...
                    a(this, e), (this._statuses = t.statuses), (this._headers = t.headers);
                }
                return (
                    n(e, [
                        {
            ...
            F = n(function e(t) {
                ...
                a(this, e),
                            ...
                            _().mark(function e(t) {
                                ...
                                return _().wrap(function (e) {
                                    for (;;)
                                        switch ((e.prev = e.next)) {
                                            case 0:
                                                if (((n = t.response), !r._cacheableResponse.isResponseCacheable(n))) {
                                                    e.next = 3;
                                                    break;
                                                }
                    ...
                    (this._cacheableResponse = new B(t));
            });
        function H(e, t, r) {
            return (
                t in e
            ...
            return e !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
                ? (
                    ...
                    ? function () {
                          ...
                          return e.apply(ae(this), r), ne(Y.get(this));
                      }
                    : function () {
                          for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                          return ne(e.apply(ae(this), r));
                      }
                : function (t) {
                      for (var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), a = 1; a < r; a++)
                          n[a - 1] = arguments[a];
                      var i = e.call.apply(e, [ae(this), t].concat(n));
                      return z.set(i, t.sort ? t.sort() : [t]), ne(i);
                  };
        }
        function re(e) {
            return 'function' === typeof e
                ...
                : (e instanceof IDBTransaction &&
                  ...
                  (t = e),
                  ($ || ($ = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(function (e) {
        ...
        function ne(e) {
            ...
            var t = re(e);
            return t !== e && (X.set(e, t), Z.set(t, e)), t;
        }
        var ae = function (e) {
            return Z.get(e);
        };
            ...
            return (
                a &&
                    c.addEventListener('upgradeneeded', function (e) {
                        a(ne(c.result), e.oldVersion, e.newVersion, ne(c.transaction));
                    }),
                n &&
        ...
        ee = (function (e) {
            return V(
                ...
                {
                    get: function (t, r, n) {
                        return ue(t, r) || e.get(t, r, n);
                    },
                    has: function (t, r) {
                        return !!ue(t, r) || e.has(t, r);
                    }
                }
            );
        })(ee);
        r(977);
        var he = 'cache-entries',
            fe = function (e) {
                    ...
                    n(e, [
                        {
                            key: '_upgradeDb',
                            value: function (e) {
                                var t = e.createObjectStore(he, { keyPath: 'id' });
                                            ...
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        ...
                                                        case 2:
                                                            return (
                                                                (r = e.sent), (e.next = 5), r.get(he, this._getId(t))
                                                            );
                                                        case 5:
                                                            return (
                                                                (n = e.sent),
                                                                e.abrupt(
                                                                    'return',
                                                                    null === n || void 0 === n ? void 0 : n.timestamp
                                                                )
                                                            );
                                                        case 7:
                                                        case 'end':
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        ...
                                                        case 18:
                                                            ...
                                                            return (f = h[u]), (e.next = 22), n.delete(he, f.id);
                                                        case 22:
                                                            o.push(f.url);
                                                        case 23:
                                                            u++, (e.next = 18);
                                                ...
                                                for (;;)
                                                    switch ((t.prev = t.next)) {
                                                        ...
                                                        case 23:
                                                            ...
                                                            return (
                                                                (t.next = 28), T(f, i.clone(), ['__WB_REVISION__'], h)
                                                            );
                                                        case 28:
                    ...
                    n(e, [
                        {
                            key: 'handle',
                            value: function (e) {
                                return ve(this.handleAll(e), 1)[0];
                            }
                        },
                        {
                            key: 'handleAll',
                            value: function (e) {
                                ...
                                var t = e.event,
                                    ...
                                    a = new we(this, { event: t, request: r, params: n }),
        ...
        (_e.defaultPrecacheCacheabilityPlugin = {
            ...
            (_e.copyRedirectedCacheableResponsesPlugin = {
                cacheWillUpdate: function (e) {
                    return E(
                        _().mark(function t() {
                            var r;
            ...
            Ee = (function () {
                function e() {
                    ...
                    a(this, e),
                        ...
                        (this._strategy = new _e({
                            cacheName: w(r),
                            plugins: [].concat(ye(i), [new xe({ precacheController: this })]),
                            fallbackToNetwork: c
                        })),
                ...
                return (
                    n(e, [
                                                ...
                                                function (e) {
                                                    for (;;)
                                                        switch ((e.prev = e.next)) {
                                                            case 0:
                                                                return (
                                                                    (e.next = 2), self.caches.open(t.strategy.cacheName)
                                                                );
                                                            case 2:
                        ...
                        },
                        {
                            key: 'getCachedURLs',
                            value: function () {
                                return ye(this._urlsToCacheKeys.keys());
                            }
                        },
                        {
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            ...
                                                            return (
                                                                (e.next = 5), self.caches.open(this.strategy.cacheName)
                                                            );
                                                        case 5:
        ...
        var Ce,
            ...
            Te = (function () {
                function e(t, r) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Oe;
                    a(this, e), (this.handler = Se(r)), (this.match = t), (this.method = n);
                }
                return (
                    n(e, [
                        {
                    ...
                    n(e, [
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                if (a.protocol.startsWith('http')) {
                                    ...
                                    var h = r.method;
                                    if (
                                        (!u && this._defaultHandlerMap.has(h) && (u = this._defaultHandlerMap.get(h)),
                                        u)
                                    ) {
                                        var f;
                                        0;
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                this._defaultHandlerMap.set(t, Se(e));
                            }
                        },
                        {
                            key: 'setCatchHandler',
                            value: function (e) {
                                this._catchHandler = Se(e);
                            }
                        },
                        {
                            key: 'registerRoute',
            ...
            je = function () {
                return Ce || ((Ce = new Pe()).addFetchListener(), Ce.addCacheListener()), Ce;
            };
        function qe(e, t, r) {
            var n;
            if ('string' === typeof e) {
            ...
            } else if (e instanceof RegExp) n = new De(e, t, r);
                ...
                function (g) {
                    for (;;)
                        switch ((g.prev = g.next)) {
                            ...
                            case 5:
                                return (h = Ne(u, n)), (g.next = 8), h.href;
                            case 8:
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    ...
                                                    case 21:
                                                        ...
                                                        throw new d('no-response', { url: t.url, error: a });
                                                    case 24:
                                                        return e.abrupt('return', n);
                                                    case 25:
                                                    case 'end':
        ...
        var Me,
            We = [
                { revision: 'b14bd5856af3856919d97535a949817f', url: '/cl421io/index.html' },
                { revision: 'cc10f20f305e5cc6ddbf7c82cccd7de6', url: '/cl421io/public/pwa-ver.txt' },
                { revision: null, url: '/cl421io/static/css/main.5f174777.css' },
                { revision: null, url: '/cl421io/static/js/529.6eb9a07e.chunk.js' },
                { revision: null, url: '/cl421io/static/js/638.4ea49024.chunk.js' },
                { revision: null, url: '/cl421io/static/js/main.32323914.js' },
                {
                    revision: 'c86bab634f3eeaff34810cfba72a547a',
                    url: '/cl421io/static/media/flash.e0176ee67d3e648d628826369d553165.svg'
                },
                {
                    revision: '18dc6830aaf1d03f9f16065431d8cc3c',
                    url: '/cl421io/static/media/refresh.b55384cffa7553c516e6f4437f088dbb.svg'
                }
            ];
        console.log(We),
            (function (e) {
                ...
                We.filter(function (e) {
                    return 'string' === typeof e ? -1 === e.indexOf('.txt') : -1 === e.url.indexOf('.txt');
                })
            ),
            (function (e) {
                var t = Le();
        ...
        qe(
            function (e) {
                ...
                return (
                    ...
                    !r.pathname.startsWith('/_') && !r.pathname.endsWith('pwa-ver.txt') && !r.pathname.match(Fe))
                );
            },
            ((Be = '/cl421io/index.html'), Le().createHandlerBoundToURL(Be))
        ),
            qe(
                function (e) {
                    var t = e.url;
                    return (
                        ...
                        '/service-worker.js' !== t.pathname && !t.pathname.endsWith('pwa-ver.txt')
                    );
                },
                new Ke({
                    cacheName: 'max-cache',
                    ...
                    plugins: [
                        new de({ maxEntries: 500, maxAgeSeconds: 63072e3, purgeOnQuotaError: !0 }),
                        new F({ statuses: [0, 200] })
                    ]
                })
            ),
            self.addEventListener('message', function (e) {
                console.log(e.data), e.data && 'SKIP_WAITING' === e.data.type && self.skipWaiting();
            });
    })();
})();
