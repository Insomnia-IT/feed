            ...
            return participationArray.map((item) => {
                return (
                    <div key={generateRandomString()}>
                        <span className={styles.participationDescr}>{`${item.year} год`}</span>
                        <RadarChartOutlined style={{ marginRight: '3px' }} />
                        <span className={styles.participationDescr}>{item.direction.name}</span>
                        <span className={styles.participationDescr}>{`(${item.role.name})`}</span>
                    </div>
                );
            });
        } else {
        ...
        <div className={styles.edit}>
            ...
            <div className={styles.formWrap}>
                ...
                <div id='section7' className={styles.formSection}>
                    ...
                    <div className={styles.ParticipateWrap}>{returnParticipationLayout()}</div>
                </div>
            </div>
            <Modal
