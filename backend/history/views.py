...
class HistoryFilter(FilterSet):
    ...
    actor_badge = filters.CharFilter(field_name='actor_badge', lookup_expr='exact')

    class Meta:
        model = History
        fields = ['object_name', 'object_id', 'status', 'date', 'date_start', 'date_end', 'volunteer_uuid', 'group_operation_uuid']
