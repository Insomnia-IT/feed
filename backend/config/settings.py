...
MIDDLEWARE = [
    ...
    'config.get_request.RequestMiddleware'
]
...
SYNCHRONIZATION_URL = os.environ.get("SYNCHRONIZATION_URL", "")
SYNCHRONIZATION_LOGIN = os.environ.get("SYNCHRONIZATION_LOGIN", "")
SYNCHRONIZATION_PASSWORD = os.environ.get("SYNCHRONIZATION_PASSWORD", "")

SKIP_BACK_SYNC = os.environ.get("SKIP_BACK_SYNC", "") == "True"
